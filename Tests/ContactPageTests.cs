...
{ 
    ...
    public void Tests()
    {
        ...
        contactPageObject.ScrollToLeaveUsAMessageWindow();
        contactPageObject.VerifyLeaveUsAMessageWindowDisplayed();
        contactPageObject.FillTheRequiredFields();
        contactPageObject.SendMessage();
        contactPageObject.VerifyMessageSent();
    }
